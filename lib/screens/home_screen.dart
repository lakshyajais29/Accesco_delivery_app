...
class _C {
  ...
  static const brandTan = Color(0xFFC0392B);
...
// ─── MINIMAL FOMO WIDGETS ────────────────────────────────────────────────────
// Each widget is compact, single-line, no stacking

/// Pulsing dot + stock text — only shown when stock < 4
...
class _StockDotState extends State<_StockDot>
      ...
      builder: (_, __) => Row(
        ...
        children: [
          ...
          Text(
            ...
            style: _T.mono(9, color: _C.stockGrn),
          ),
        ],
      ),
    );
...
/// Sale countdown — compact single line
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: Text(
            'Order in ${m}m → ${widget.cutoff}',
          style: _T.mono(9, color: _C.amber),
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(
                    child: _JustDroppedRail(
                      ...
                      wishlist: _wishlist,
                      onWish: (k) => setState(() =>
                          _wishlist.contains(k) ? _wishlist.remove(k) : _wishlist.add(k)),
                    ),
                  ),
                  SliverToBoxAdapter(
                  ...
                  SliverToBoxAdapter(
                    child: _RailHeader(
                        label: 'TRENDING IN HYDERABAD', accentColor: _C.amber),
                  ),
                  SliverToBoxAdapter(
                    child: _TrendingRail(
                      products: _trending,
                  ...
                  SliverToBoxAdapter(
                    child: _RailHeader(
                        label: 'VIBE CHECK', accentColor: const Color(0xFF7C3AED)),
                  ),
                  SliverToBoxAdapter(
            ...
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  ...
                  errorBuilder: (_, __, ___) =>
                      Container(width: 30, height: 30, color: _C.magenta),
                ),
              ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Center(
                      child: Icon(Icons.person, size: 18, color: _C.dark)),
                ),
              ),
            ],
          ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Search outfits, sarees, sneakers...',
        ...
        if (badge != null)
          Positioned(
            ...
            child: Container(
              ...
              child: Center(
                child: Text('$badge',
                    style: _T.label(8, color: _C.white, spacing: 0)),
              ),
            ),
          ),
      ],
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    color: _C.magenta,
                    child: Text(b.eyebrow,
                        style: _T.label(10, color: _C.white, spacing: 2.5)),
                  ),
                  const SizedBox(height: 8),
                  Text(b.headline,
                      style: _T.display(58, color: _C.white, spacing: -1)),
                  const SizedBox(height: 4),
                  Text(b.sub,
                      style: _T.body(13, color: const Color(0xCCFFFFFF))),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(b.cta,
                              style: _T.label(12, color: _C.dark, spacing: 1.5)),
                          const SizedBox(width: 8),
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text('QUICK REORDER',
                  style: _T.label(13, color: _C.white, spacing: 1.5)),
              const Spacer(),
              Text('SEE ALL',
                  style: _T.label(11, color: _C.magenta, spacing: 1.5)),
            ],
          ),
          const SizedBox(height: 3),
          Text('Your recent orders — one tap away',
          ...
          return GestureDetector(
            onTap: () {
              if (e.key == 1) {
                ...
                Navigator.push(context,
                    MaterialPageRoute(
                        builder: (_) => const ThriftMarketplaceScreen()));
              } else if (e.key == 4) {
                Navigator.push(context,
                    MaterialPageRoute(
                  ...
                  Stack(
                    ...
                    children: [
                      Icon(active ? e.value.$2 : e.value.$1,
                          size: 22,
                          color: active ? _C.dark : _C.grey500),
                      if (e.key == 4)
                        Positioned(
                          top: -5, right: -8,
                          child: Container(
          ...
          Expanded(
            child: Text(label,
                style: GoogleFonts.bebasNeue(
                    fontSize: 22, color: _C.dark, letterSpacing: 0.5)),
          ),
          GestureDetector(
            onTap: () {},
            child: Text('SEE ALL',
...
// ─────────────────────────────────────────────────────────────────────────────
// SHARED PRODUCT CARD
// Fixed height, no overflow. Primary signal only (1 FOMO line max).
// ─────────────────────────────────────────────────────────────────────────────

// Card dimensions — consistent across all rails
const double _kImgH   = 155.0; // image height
const double _kInfoH  = 72.0;  // info panel height
const double _kCardH  = _kImgH + _kInfoH; // = 227
...
class _ProductCard extends StatelessWidget {
  ...
  final Widget? badge;       // top-left overlay badge
  final Widget? fomoSignal;  // single FOMO line in info panel
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(
                          ...
                          size: 16,
                          color: wished ? _C.magenta : _C.white,
                        ),
                      ),
                    ),
                  ),
                      ...
                      child: p.salePrice != null
                          ? Row(
                              ...
                              children: [
                                ...
                                Text(p.price,
                                    style: _T
                                        .body(10, color: const Color(0xAAFFFFFF))
                                        .copyWith(
                                            decoration:
                          ...
                          : Text(p.price,
                              style:
                                  _T.label(11, color: _C.white, spacing: 0)),
                    ),
                  ),
                ],
              ),
    ...
    final paint = Paint()
      ..shader = LinearGradient(
        ...
        stops: const [0.0, 0.3, 0.5, 0.7, 1.0],
          ...
          (progress - 0.5) * size.width * 2, 0, size.width, size.height));
...
// ─────────────────────────────────────────────────────────────────────────────
// RAIL 1: JUST DROPPED
// Signal per card: droppedMinsAgo (primary). saleEndsAt shown only if present.
// ─────────────────────────────────────────────────────────────────────────────
class _JustDroppedRail extends StatefulWidget {
  final List<_Product> products;
  final Set<int> wishlist;
  final void Function(int) onWish;
  const _JustDroppedRail(
      {required this.products, required this.wishlist, required this.onWish});
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (_, i) {
          ...
          final key    = 1000 + i;
          final wished = widget.wishlist.contains(key);

          // Primary FOMO: dropped time. Fallback: sale timer.
          Widget fomoSignal;
          ...
          // NEW badge with subtle shimmer glow
          final badge = Stack(
              ...
              Positioned(
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (_, __) => CustomPaint(
                    painter: _ShimmerBarPainter(_shimCtrl.value),
                  ),
                ),
              ),
            ],
...
// ─────────────────────────────────────────────────────────────────────────────
// RAIL 2: ALMOST GONE
// Signal per card: stock (primary). Delivery window if very urgent (≤10 min).
// Sale timer only when no delivery urgency.
// ─────────────────────────────────────────────────────────────────────────────
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (_, i) {
          final p      = products[i];
          final key    = 2000 + i;
          final wished = wishlist.contains(key);

          // Priority: delivery urgency (≤10 min) > stock counter > sale timer
          Widget fomoSignal;
          if (p.deliveryCutoff != null && p.deliveryMinsLeft > 0 &&
              p.deliveryMinsLeft <= 10) {
            fomoSignal = _DeliveryTag(
                cutoff: p.deliveryCutoff!,
                minsLeft: p.deliveryMinsLeft);
          } else if (p.stock < 4) {
          ...
          // Badge: SALE tag or stock indicator
          final badge = p.salePrice != null
              ? Container(
                  padding: const EdgeInsets.symmetric(
...
// ─────────────────────────────────────────────────────────────────────────────
// RAIL 3: TRENDING IN YOUR CITY
// Signal per card: rank badge + "X ordered today" text. Clean & simple.
// ─────────────────────────────────────────────────────────────────────────────
        ...
        itemBuilder: (_, i) {
          ...
          final badge = Container(
            ...
            child: Text('#${p.cityRank}',
                style: _T.label(10, color: _C.white, spacing: 0)),
          );
              ...
              ? Row(
                  ...
                  children: [
                    ...
                    Text('${p.orderedToday} ordered today',
                        style: _T.body(9, color: _C.amber)),
                  ],
                )
...
// ─────────────────────────────────────────────────────────────────────────────
// RAIL 4: VIBE CHECK
// Signal per card: friend vote count. Override banner only when stock=1.
// ─────────────────────────────────────────────────────────────────────────────
class _VibeCheckRail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      // Slightly taller only for stock=1 cards which show the slim alert bar
      height: _kCardH + 22,
      child: ListView.separated(
        scrollDirection: Axis.horizontal,
        padding: const EdgeInsets.symmetric(horizontal: 16),
        ...
        itemBuilder: (_, i) {
          ...
          final fomoSignal = Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...List.generate(min(3, (p.friendVotes / 8).ceil()), (d) =>
                  Transform.translate(
              ...
              SizedBox(width: (min(3, (p.friendVotes / 8).ceil()) * 4.0) + 4),
              Text('${p.friendVotes} voted YES',
                  style: _T.body(9, color: _C.grey700)),
            ],
          );
          ...
          return SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                // Slim urgent alert — only for stock=1
                if (isUrgent)
                  _UrgentStripWidget(votes: p.friendVotes),
              ],
            ),
          );
        },
...
/// Slim strip below card — only when stock = 1
...
class _UrgentStripWidgetState extends State<_UrgentStripWidget>
    with SingleTickerProviderStateMixin {
  late final AnimationController _ctrl;
  @override
  void initState() {
